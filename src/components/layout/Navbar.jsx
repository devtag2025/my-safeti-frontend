...
import { Menu, X, LogOut, ChevronDown, Home, User, FileText, Settings } from "lucide-react";
  ...
  const navLinks = [
    ...(user?.role === "user"
      ? [
        ...
        { name: "Media Requests", path: "/media-requests", icon: <FileText size={16} /> },
      ]
      : []),

    ...(user?.role === "admin"
      ? [
        { name: "Media Review", path: "/media-review", icon: <FileText size={16} /> },
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg border border-gray-200 overflow-hidden animate-in slide-in-from-top-5 fade-in-20">
                  <div className="p-3 border-b border-gray-100">
                    ...
                    <p className="font-medium text-gray-900 truncate capitalize">{userName || "User"}</p>
                  </div>
                  ...
                  <div className="py-1 border-t border-gray-100">
                    ...
                    >
                      <LogOut size={16} className="mr-2 text-gray-500 group-hover:text-red-500" />
            ...
            {user ? (
              <div className="px-4 space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  >
                    <LogOut size={16} className="mr-3 text-gray-500 group-hover:text-red-500" />
                    Sign out
                  </button>
                </div>
              </div>
