...
const PDFExport = {
  downloadReportAsPDF: (report) => {
    ...
    doc.setFontSize(16);
    doc.text("My Safeti.com.au Incident Report", 105, 20, null, null, "center");
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.text(
        `Generated by My Safeti.com.au - Page ${i} of ${pageCount}`,
        105,
  ...
  exportAnalytics: (reports, format = "pdf") => {
    ...
    doc.setFont("helvetica", "bold");
    doc.setFontSize(16);
    doc.text("My Safeti Analytics Report", 105, 20, null, null, "center");
