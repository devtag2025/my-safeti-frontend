...
const AdminDashboard = () => {
  ...
  const menuItems = [
    ...
    { id: "users", label: "User Management", icon: <UsersRound className="w-5 h-5" /> },
    { id: "reports", label: "Report Moderation", icon: <FileText className="w-5 h-5" /> },
    { id: "ads", label: "Advertisement", icon: <BarChart className="w-5 h-5" /> },
    { id: "revenue", label: "Revenue Analytics", icon: <DollarSign className="w-5 h-5" /> },
  ];
...
const RevenueDashboard = () => {
  const revenueData = {
    totalEarnings: 24598.50,
    adRevenue: 12450.75,
    mediaRequests: 8723.25,
    otherRevenue: 3424.50,
    monthlyComparison: [
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-xl font-semibold">${revenueData.totalEarnings.toLocaleString()}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-xl font-semibold">${revenueData.adRevenue.toLocaleString()}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-xl font-semibold">${revenueData.mediaRequests.toLocaleString()}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-xl font-semibold">${revenueData.otherRevenue.toLocaleString()}</p>
            </div>
          </div>
        </div>
      </div>
