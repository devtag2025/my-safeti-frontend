        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our platform enables you to report dangerous driving behaviors in
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    $100 AUD for approved media submissions.
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
            ...
            <div className="bg-white p-8 rounded-lg shadow-md border border-gray-100">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    <span className="font-medium">Media evidence</span> - Access
                    to verified incident media for $139 AUD.
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 italic">
                ...
                actual driver behavior rather than just demographics and claims
                history."
              </p>
              <div className="flex text-yellow-400 mt-4">
                <svg
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 italic">
                "I reported a driver who ran a red light, and the process was so
                straightforward. I even received a reward when my dashcam
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-500 to-indigo-700 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-indigo-100 max-w-2xl mx-auto">
            Join thousands of Australians who are already contributing to safer
            roads. Sign up today or report an incident.
          </p>
          ...
          <div className="max-w-3xl mx-auto divide-y divide-gray-200">
            <div className="py-6">
              ...
              {activeQuestion === 0 && (
                <div className="mt-3 text-gray-600">
                  <p>
                    SafeStreet employs a multi-step verification process. First,
                    all reports are reviewed by our team to ensure they contain
                    accurate and complete information. Reports with submitted
                    media undergo an additional review to verify the incident.
                    We also use pattern recognition algorithms to identify
                    consistent behaviors across multiple reports for the same
            ...
            <div className="py-6">
              ...
              {activeQuestion === 1 && (
                <div className="mt-3 text-gray-600">
                  <p>
                    Yes, SafeStreet takes privacy very seriously. Your personal
                    information is never shared with the reported drivers or
                    made public. When insurance companies access our data, they
                    can only see anonymized report information. All data is
                    handled in accordance with Australian privacy laws and our
              ...
              {activeQuestion === 2 && (
                <div className="mt-3 text-gray-600">
                  <p>
                    ...
                    you'll receive a notification. Once you approve the request,
                    the $100 AUD payment will be processed through your chosen
                    payment method (PayPal or direct deposit). Payments are
                    typically processed within 3-5 business days after approval.
                  </p>
                </div>
              )}
            </div>
              ...
              {activeQuestion === 3 && (
                <div className="mt-3 text-gray-600">
                  <p>
                    ...
                    emergency services (000) first. Our platform is not intended
                    for reporting parking violations or minor infractions.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="py-6">
              ...
              {activeQuestion === 4 && (
                <div className="mt-3 text-gray-600">
                  <p>
                    Insurance companies can sign up for client accounts through
                    our website. After verification, they gain access to our
                    client portal where they can search for specific vehicle
                    registrations, view report histories, analyze risk patterns,
                    and request access to media evidence. Different subscription
                    levels are available based on data access needs.
                  </p>
                </div>
              )}
            </div>
